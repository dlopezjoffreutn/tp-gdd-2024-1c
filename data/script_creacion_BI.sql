...
CREATE TABLE DASE_DE_BATOS.BI_HECHOS_ENVIOS (
	...
	SUCURSAL_ID decimal(18, 0) not null,
	LOCALIDAD_ID decimal(18, 0) not null,
	TIEMPO_PROGRAMADO_ID decimal(18, 0) not null,
	...
	CONSTRAINT FK_BI_ENVIO_TIEMPO_PROGRAMADO FOREIGN KEY (TIEMPO_PROGRAMADO_ID) REFERENCES DASE_DE_BATOS.BI_DIMENSION_TIEMPO(ID),
	CONSTRAINT FK_BI_ENVIO_TIEMPO_ENTREGA FOREIGN KEY (TIEMPO_ENTREGA_ID) REFERENCES DASE_DE_BATOS.BI_DIMENSION_TIEMPO(ID),
